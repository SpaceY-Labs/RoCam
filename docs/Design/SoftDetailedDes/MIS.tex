...
\begin{enumerate}
  ...
  \item Give a brief overview of other design solutions you considered. What are the
    ...
    \item Reflection on implementing the other group's module:\\
        The other group's capstone vision is an AI voice-powered computer for
        people with disabilities. Our team is fascinated by their vision because this
        is our top backup project. The module our team was assigned to implement was the
        entire UI of the AI voice-powered computer. Our team was confused at first
        because the entire UI is not traditionally considered to be a module. We began
        by searching through relevant documentation about the UI requirements and API
        specifications or code. Unfortunately, we found only minimal UI documentation
        ...
        our ability based on the existing requirements documents. After the feature was
        done, we opened a PR and left a comment outlining the lack of documentation
        during our implementation. At the time of writing this reflection, the other group
        is unresponsive to our comments. Overall, we understood the importance of clear
        documentation and module definition when working on a collaborative project, since
        it is difficult to implement a feature that is not properly specified and when
        communication is ineffective. We also learned that it is important to consider
        module size to properly distribute workloads.
