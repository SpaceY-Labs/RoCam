...
possible. \textbf{Unit testing, integration testing, and system testing are
performed;} only field testing is out of scope. Verification relies on
structured internal reviews and checklists, plus unit tests, integration tests,
and system tests, to confirm functional behavior and safety assumptions.
Validation is limited to a planned review with the McMaster Rocketry Team
(stakeholders) to collect feedback; no task-based inspection, classmate
review, or supervisor validation is conducted. Roles and responsibilities are
assigned to team members only, with feedback from the rocketry team captured
and tracked. Priorities emphasize correctness, performance, reliability, and
safety; lower-priority or out-of-scope items (e.g., exhaustive usability
studies, independent verification of third-party components, and field
testing) are noted to keep the plan feasible. The document concludes with traceability tables, placeholders for
...
thorough, traceable, and aligned with project requirements. The plan emphasizes unit testing, integration testing, system testing, and
internal review to confirm that functional and performance criteria are
addressed where possible, with improvements tracked through GitHub Issues.
Validation focuses on a planned review with the McMaster Rocketry Team
...
reviews, unit testing, integration testing, and system testing, as well as the
validation strategy through a
...
or supervisor validation are performed; unit testing, integration testing, and
...
scope. Unit testing, integration testing, and system testing are performed.
...
testing} is out of scope. Unit tests, integration tests, and system tests
described in this section are executed. Evidence of correctness comes from unit
tests, integration tests, system tests, and the planned stakeholder review
...
\subsubsection*{test-acquire-frame: Camera Frames are Acquired at Startup}
\begin{itemize}
...
(Appendix 6.2). Under the current plan, no field testing is performed; unit testing,
integration testing, system testing, and a planned stakeholder review with the
rocketry team are conducted.
...
Field testing and user surveys are out of scope; unit testing, integration
testing, system testing, and the stakeholder review are performed.
...
\begin{itemize}
  ...
  \item \textbf{How Test Will Be Performed:} Not performed. If field testing were in scope, the client would fill out the survey after the field test. Under the current plan, unit testing, integration testing, system testing, and stakeholder review are conducted.
\end{itemize}
...
\begin{longtable}{|p{4.5cm}|p{10cm}|}
  ...
  \hline
  \mref{mTranscodeManagement} (Transcode Management) & test-transcode-read-log; test-transcode-shader-probe; test-transcode-bus-call                                                                                                                                                                     \\
  \hline
