...
possible. \textbf{Unit testing and system testing are
  performed;} only field testing is out of scope. Verification relies on
structured internal reviews and checklists, plus unit tests and system tests,
to confirm functional behavior and safety assumptions.
...
unit testing, system testing, and internal review to
...
reviews, unit testing, and system testing, as well as the
...
implemented as system tests in the final stages of development.
...
\begin{table}[H]
  ...
  \begin{tabular}{|p{4.4cm}|p{10.1cm}|}
    ...
    System Verification                             & $\square$ \; Conduct system tests covering all
...
or supervisor validation are performed; unit testing and system testing are conducted.
...
testing, system testing, and a planned stakeholder review
...
Field testing and user surveys are out of scope; unit testing, system
testing, and the stakeholder review are performed.
