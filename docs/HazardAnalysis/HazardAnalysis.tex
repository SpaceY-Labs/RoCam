...
Such hazard analysis will not only be used to identify potential hazards caused by
the system, but also to minimize risks related to unforeseen cases. The purpose
...
is used to deploy our computer vision module and communicate directly
...
\begin{enumerate}
  ...
  \item M4 (End Sprint 8): Safety package complete (FMEA v2, SR1--SR4 verified, documentation).
\end{enumerate}

\subsection{Traceability Plan}
\begin{itemize}
  \item FMEA \(\rightarrow\) SR mapping: “Gimbal snaps/overshoots” \(\rightarrow\) SR1;
        “Tracking lost” \(\rightarrow\) SR3; “Emergency halt needed” \(\rightarrow\) SR4;
        “UI unavailable/unclear” \(\rightarrow\) UI alarms, SOP, tests.
